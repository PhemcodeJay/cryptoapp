      ...
      <div className="space-y-6">
        <div>
          ...
          <input
            ...
            className="w-full p-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-blue-500 mb-2"
          />
        </div>
